/**
*@param layerbase   Capa base del mapa.
*@param viz         Mapa de carto viz.json
*@param div         Id del elemento html donde se renderiza el mapa.
*@param users       Parametro del usuario de carto en  formato json {user:'',api_key:''}
*                   el api_key solo si es necesaria.
*@param paramlayerbase Parametros de  configuracion de la capa base.
*@param parammapbase   Parametros de configuracion del mapa de leaflet
**/
...
cdmxCarto.prototype = {
    ...
    onEachFeature:function(feature, layer) {
           ...
           layer.on({
             ...
             highlight(e.target); // Hay problemas con esta funcion
           },
               mouseout: function (e) {
             dehighlight(e.target); // Hay problemas con esta funcion
           },
               click: function (e) {
                 select(e.target);
               }
